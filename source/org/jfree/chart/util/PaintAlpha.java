...
public class PaintAlpha {
    ...
    public static Paint darker(Paint paint) {
        ...
        if (paint instanceof LinearGradientPaint) {
            return darker((LinearGradientPaint) paint);
        }
        if (paint instanceof RadialGradientPaint) {
            return darker((RadialGradientPaint) paint);
        }
     ...
     */
    public static GradientPaint darker(GradientPaint paint) {
     ...
     */
    public static LinearGradientPaint darker(LinearGradientPaint paint) {

        final Color[] paintColours = paint.getColors();
     ...
     */
    public static RadialGradientPaint darker(RadialGradientPaint paint) {
     ...
     * @return a darker version of the <code>TexturePaint</code>
     */
    public static TexturePaint darker(TexturePaint paint) {
        /**
         ...
         */
        if (paint.getImage().getColorModel().isAlphaPremultiplied()) {/* Placeholder */}
