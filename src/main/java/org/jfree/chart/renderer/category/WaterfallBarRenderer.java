 ...
 *   {@link org.jfree.chart.renderer.AbstractRenderer#setSeriesPaint(int, Paint)})
 *   are ignored;</li>
 * </ul>
...
public class WaterfallBarRenderer extends BarRenderer {
    ...
    /**
     * Sets the paint that will be used to draw the first bar and calls
    ...
    /**
     * Sets the paint that will be used to draw the last bar and calls
     * {@link #fireChangeEvent()}.
     *
     * @param paint  the paint ({@code null} not permitted).
     */
