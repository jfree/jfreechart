...
public interface CategoryItemRenderer extends ChartElement, LegendItemSource {
         ...
         * listeners.
         *
         * @param intervalCategoryToolTipGenerator the generator ({@code null}
         *                                         permitted).
         *
         * @see #getDefaultToolTipGenerator()
         */
        void setDefaultToolTipGenerator(IntervalCategoryToolTipGenerator intervalCategoryToolTipGenerator);
        ...
        void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot<?, ?> plot,
                        CategoryAxis domainAxis, ValueAxis rangeAxis, CategoryDataset<?, ?> dataset, int row,
                        int column,
                        int pass);
