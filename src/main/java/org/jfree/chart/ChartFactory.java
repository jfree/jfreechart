...
public abstract class ChartFactory {
    ...
    public static JFreeChart createPieChart(String title, PieDataset dataset) {
        return PieChartFactory.createPieChart(title, dataset);
    }

    public static JFreeChart createPieChart(String title, PieDataset dataset,
                                            boolean legend, boolean tooltips, boolean urls) {
        return PieChartFactory.createPieChart(title, dataset, legend, tooltips, urls);
    }

    public static JFreeChart createPieChart(String title, PieDataset dataset,
                                            boolean legend, boolean tooltips, Locale locale) {
        return PieChartFactory.createPieChart(title, dataset, legend, tooltips, locale);
    }

    public static JFreeChart createRingChart(String title, PieDataset dataset,
                                             boolean legend, boolean tooltips, boolean urls) {
        return PieChartFactory.createRingChart(title, dataset, legend, tooltips, urls);
    }

    public static JFreeChart createMultiplePieChart(String title,
                                                    CategoryDataset dataset, TableOrder order, boolean legend,
                                                    boolean tooltips, boolean urls) {
        return PieChartFactory.createMultiplePieChart(title, dataset, order,
